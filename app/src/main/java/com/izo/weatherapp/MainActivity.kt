package com.izo.weatherapp

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.activity.viewModels
import com.izo.weatherapp.databinding.ActivityMainBinding
import com.izo.weatherapp.viewmodel.WeatherViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.weatherResp.observe(this) { weather ->
            binding.apply {
                ...
                val forecast1 = weather.forecast?.get(0)
                val forecast2 = weather.forecast?.get(0)
                val forecast3 = weather.forecast?.get(0)
